...
func TestEIP2200(t *testing.T) {
	...
	for i, tt := range eip2200Tests {
		...
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			vmctx := BlockContext{
				CanTransfer:     func(IntraBlockState, libcommon.Address, *uint256.Int) bool { return true },
				Transfer:        func(IntraBlockState, libcommon.Address, libcommon.Address, *uint256.Int, bool) {},
				ContractHasTEVM: func(libcommon.Hash) (bool, error) { return false, nil },
			}
